        ...
        <div className="flex flex-col items-center justify-center w-full h-screen">
            <div className="flex h-full">
                <div className="w-1/2 flex flex-col items-center justify-center">
                    <h1 className="text-5xl w-1/2 font-bold text-white">
                        Find Your Word!
                    </h1>
                    <h1 key={currentIndex} className="text-5xl w-1/2 text-[#FF1000] font-bold animate-pop-up">
                        {myFourSides[currentIndex]}
                    </h1>
                    <h1 className="text-5xl w-1/2 font-bold text-[#0A1A6E] mb-10">lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor incididunt</h1>
                    <div className="w-1/2">
                        <NavLink to='/wordit' className="flex items-center justify-between text-2xl py-1 bg-[#0A1A6E] rounded-full w-1/2 text-white transition-all font-medium hover:translate-y-1.5 hover:bg-[#0A1A6E]/90">
