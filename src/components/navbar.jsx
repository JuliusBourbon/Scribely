...
const Navbar = () => {
    ...
    // State untuk menu hamburger di mobile
    ...
    // Fungsi untuk menutup semua menu saat link di-klik
    const closeAllMenus = () => {
    ...
    // ClassName untuk link di dalam dropdown desktop
    ...
    // ClassName untuk link di menu mobile
    ...
    return (
        <nav className="sticky top-0 left-0 right-0 flex items-center justify-between px-6 sm:px-10 py-4 bg-transparent z-50">
            ...
            <div className="hidden md:flex items-center gap-8 text-white">
                ...
                <div className="relative">
                    <button
                        ...
                        className="flex items-center gap-1.5 font-medium text-white hover:text-[#FF1000] transition-colors"
                    >
                        Word It!
                        <svg
                            ...
                            strokeWidth={3}
                            stroke="currentColor"
                            className={`w-3 h-3 transition-transform duration-300 ${isDropdownExpanded ? 'rotate-180' : ''}`}
                        >
                    ...
                    {isDropdownExpanded && (
                        <div
                            className="absolute top-full mt-3 w-40 flex flex-col p-2 rounded-md bg-white/90 backdrop-blur-sm shadow-lg"
                        >
            ...
            <div className="hidden sm:block">
                <a target="_blank" rel="noopener noreferrer" href="https://trakteer.id/juliusbourbon/gift" className="bg-[#001D6E] text-white font-bold px-6 py-2.5 rounded-full shadow hover:bg-opacity-90 transition-colors">
                    Donate!
                </a>
            </div>
            ...
            >
                <div className="flex flex-col items-center justify-center h-full gap-8">
                    ...
                    <NavLink to='/dictionary' onClick={closeAllMenus} className={mobileLinkClassName}>Dictionary</NavLink>
                     <a target="_blank" rel="noopener noreferrer" href="https://trakteer.id/juliusbourbon/gift" className="mt-4 bg-[#001D6E] text-white font-bold px-8 py-3 rounded-full shadow hover:bg-opacity-90 transition-colors text-xl">
                        Donate!
                    </a>
                </div>
            </div>
